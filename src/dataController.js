...
const dataController = (function() {
  ...
  const timeLeftStr = (task) =>{
    if (task.dueDate !== '') {
      return formatDistanceToNow(parse(task.dueDate,  'yyyy-MM-dd', new Date()),
        { includeSeconds: false, addSuffix: true });
    }
  };
  ...
  return {
    projContainer, inbox, createTask, addProject, findProject, addTaskToProject,
    deleteTask, editTask, editProject, findProjectIndex, deleteTasks,
    deleteProject, setComplete, filterTodayTask, timeLeftStr
  };
})();
