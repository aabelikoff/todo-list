...
//Defines if storage available
  ...
  return { loadProjContainer, backupProjContainer, availableStorage,
    taskRemover, projectRemover, taskSaver, tasksIdSaver, projectSaver };
})();
